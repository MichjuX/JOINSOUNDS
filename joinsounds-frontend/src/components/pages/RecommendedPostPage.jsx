...
function RecommendedPostPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await RecommendationService.getRecommendedPosts(
          page,
          size,
          sortBy,
          sortDirection,
        ...
        console.log("Recommended posts response:", response.content);
...
export default RecommendedPostPage;